...
class UIStepper extends Component {
  static propTypes = {
    ...
    verticalDecrementImage: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  ...
  static defaultProps = {
    ...
    verticalDecrementImage: require('./assets/verticaldecrement.png'),
    imageWidth: 20,
    imageHeight: 15,
    width: 94,
    height: 29,
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <Image
            source={vertical ? this.resolveImage(verticalDecrementImage) : this.resolveImage(decrementImage)}
            style={vertical ? this.resolveStyles(verticalDecrementImage) : this.resolveStyles(decrementImage)}
            resizeMode={'contain'}
          />
        </TouchableOpacity>
        {displayValue && (
          <View style={styles.valueContainer}>
            <Text style={{ color: this.state.value > 0 ? "#FBA83C" : textColor, fontSize, fontFamily }}>
              {this.state.value}
            </Text>
          </View>
        )}
